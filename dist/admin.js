(() => {
  ...
  (s.m = o),
    ...
    (() => {
      ...
      const g = { "X-Client-Info": "supabase-js/1.35.6" },
        m = "Request Failed",
      ...
      function v(n, e, t, r) {
        return w(this, void 0, void 0, function* () {
          return B(n, "POST", e, r, t);
        });
      }
      function y(n, e, t, r) {
        return w(this, void 0, void 0, function* () {
          return B(n, "PUT", e, r, t);
        });
      }
      function x(n, e, t) {
        const r = t.map((e) => {
      ...
      function k(n, e, t) {
        e.setHeader("Set-Cookie", x(n, e, t));
      }
      ...
      class I {
        constructor({
          ...
          (this.url = n),
            (this.headers = e),
            (this.cookieOptions = Object.assign(Object.assign({}, b), t)),
            (this.fetch = O(r));
        }
          ...
          return $(this, void 0, void 0, function* () {
            try {
              ...
              const i = yield v(
                ...
                s = Object.assign({}, i);
              return (
                s.expires_in && (s.expires_at = S(i.expires_in)),
                { data: s, error: null }
              );
            } catch (n) {
          ...
          return $(this, void 0, void 0, function* () {
            try {
              const r = Object.assign({}, this.headers),
                ...
                i = Object.assign({}, o);
              return (
                i.expires_in && (i.expires_at = S(o.expires_in)),
                { data: i, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
          ...
          return $(this, void 0, void 0, function* () {
            try {
              const i = Object.assign({}, this.headers),
                ...
                A = Object.assign({}, a);
              return (
                A.expires_in && (A.expires_at = S(a.expires_in)),
                { data: A, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
          ...
          return $(this, void 0, void 0, function* () {
            try {
              const i = Object.assign({}, this.headers),
                ...
                a = Object.assign({}, s);
              return (
                a.expires_in && (a.expires_at = S(s.expires_in)),
                { data: a, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
          ...
          return $(this, void 0, void 0, function* () {
            try {
              const e = yield v(
                ...
                t = Object.assign({}, e);
              return (
                t.expires_in && (t.expires_at = S(e.expires_in)),
                { data: t, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
        ...
        createUser(n) {
          return $(this, void 0, void 0, function* () {
            try {
              const e = yield v(this.fetch, `${this.url}/admin/users`, n, {
                headers: this.headers,
              });
        ...
        getUserById(n) {
          return $(this, void 0, void 0, function* () {
            try {
              return {
                data: yield C(this.fetch, `${this.url}/admin/users/${n}`, {
                  headers: this.headers,
                }),
                error: null,
              };
        ...
        updateUserById(n, e) {
          return $(this, void 0, void 0, function* () {
            try {
              const t = yield y(this.fetch, `${this.url}/admin/users/${n}`, e, {
                headers: this.headers,
              });
        ...
        getUser(n) {
          return $(this, void 0, void 0, function* () {
            try {
              const e = yield C(this.fetch, `${this.url}/user`, {
        ...
        updateUser(n, e) {
          return $(this, void 0, void 0, function* () {
            try {
              const t = yield y(this.fetch, `${this.url}/user`, e, {
                headers: this._createRequestHeaders(n),
              });
              return { user: t, data: t, error: null };
            } catch (n) {
      ...
      class R extends class {
        constructor(n) {
          ...
          const e = Object.assign(Object.assign({}, P), n);
        ...
        getSessionFromUrl(n) {
          return D(this, void 0, void 0, function* () {
            try {
              if (!T()) throw new Error("No browser detected.");
              const e = j("error_description");
              if (e) throw new Error(e);
              const t = j("provider_token"),
                r = j("access_token");
              if (!r) throw new Error("No access_token detected.");
              const o = j("expires_in");
              if (!o) throw new Error("No expires_in detected.");
              const i = j("refresh_token");
              if (!i) throw new Error("No refresh_token detected.");
              const s = j("token_type");
        ...
        _recoverSession() {
          try {
            const n = ((n, e) => {
              const t =
                T() && (null == n ? void 0 : n.getItem("supabase.auth.token"));
                ...
                if (this.autoRefreshToken && t.refresh_token) {
                  ...
                  if (n) {
                    if (
                      ...
                      n.message === m && this.networkRetries < 10)
                    )
                      return (
      ...
      const F = { "X-Client-Info": "postgrest-js/0.37.4" };
      class L {
        constructor(
          n,
          ...
          (this.url = n),
            (this.headers = Object.assign(Object.assign({}, F), e)),
            (this.schema = t),
            (this.fetch = r),
      ...
      const H = (n, e, t = {}) => {
        ...
        K = (n, e, t, r) => {
          const o = e.find((e) => e.name === n),
            ...
            s = t[n];
          return i && !r.includes(i) ? W(i, s) : Y(s);
        },
        W = (n, e) => {
          if ("_" === n.charAt(0)) {
        ...
        Q = (n, e) => {
          ...
          if ("{" === n[0] && "}" === r) {
            ...
            return r.map((n) => W(e, n));
          }
          return n;
        },
        nn = (n) => ("string" == typeof n ? n.replace(" ", "T") : n);
      var en = s(840);
      const tn = { "X-Client-Info": "realtime-js/1.7.4" };
      var rn, on, sn, an, An;
      !(function (n) {
      ...
      class hn {
        constructor(n, e = {}, t) {
          (this.topic = n),
            ...
            (this.joinPush = new ln(this, sn.join, this.params, this.timeout)),
            (this.rejoinTimer = new cn(
              () => this.rejoinUntilConnected(),
              this.socket.reconnectAfterMs
            )),
            this.joinPush.receive("ok", () => {
              (this.state = on.joined),
        ...
        unsubscribe(n = this.timeout) {
          this.state = on.leaving;
          let e = () => {
            this.socket.log("channel", `leave ${this.topic}`),
              this.trigger(sn.close, "leave", this.joinRef());
          };
          this.joinPush.destroy();
          let t = new ln(this, sn.leave, {}, n);
          return (
        ...
        rejoin(n = this.timeout) {
          this.isLeaving() ||
            ...
            (this.state = on.joining),
            this.joinPush.resend(n));
        }
        trigger(n, e, t) {
          let { close: r, error: o, leave: i, join: s } = sn;
        ...
        isClosed() {
          return this.state === on.closed;
        }
        isErrored() {
          return this.state === on.errored;
        }
        isJoined() {
          return this.state === on.joined;
        }
        isJoining() {
          return this.state === on.joining;
        }
        isLeaving() {
          return this.state === on.leaving;
        }
      }
      const un = () => {};
      class pn {
        constructor(n, e) {
          (this.accessToken = null),
            ...
            (this.params = {}),
            (this.timeout = 1e4),
            (this.transport = en.w3cwebsocket),
          ...
          (this.accessToken = n),
            this.channels.forEach((e) => {
              n && e.updateJoinPayload({ user_token: n }),
                e.joinedOnce &&
                  e.isJoined() &&
                  e.push(sn.access_token, { access_token: n });
            });
        }
        leaveOpenTopic(n) {
        ...
        _triggerChanError() {
          this.channels.forEach((n) => n.trigger(sn.error));
        }
        _appendParams(n, e) {
        ...
        getPayloadRecords(n) {
          ...
          return (
            ("INSERT" !== n.type && "UPDATE" !== n.type) ||
              (e.new = H(n.columns, n.record)),
            ("UPDATE" !== n.type && "DELETE" !== n.type) ||
              (e.old = H(n.columns, n.old_record)),
            e
          );
        }
        on(n, e) {
      ...
      const fn = { "X-Client-Info": "storage-js/1.7.3" };
      ...
      function Bn(n, e, t, r) {
        return bn(this, void 0, void 0, function* () {
          return En(n, "GET", e, t, r);
        });
      }
      function Cn(n, e, t, r, o) {
        return bn(this, void 0, void 0, function* () {
          return En(n, "POST", e, r, o, t);
        });
      }
      function vn(n, e, t, r, o) {
        return bn(this, void 0, void 0, function* () {
          return En(n, "DELETE", e, r, o, t);
        });
      }
      const yn = (n) => {
        let e;
      ...
      class Tn {
        ...
        uploadOrUpdate(n, e, t, r) {
          return kn(this, void 0, void 0, function* () {
            try {
              let o;
              const i = Object.assign(Object.assign({}, Sn), r),
                s = Object.assign(
                  Object.assign({}, this.headers),
          ...
          return kn(this, void 0, void 0, function* () {
            try {
              const e = this._getFinalPath(n),
                t = yield Bn(this.fetch, `${this.url}/object/${e}`, {
                  headers: this.headers,
                  noResolveJson: !0,
                });
        ...
        list(n, e, t) {
          return kn(this, void 0, void 0, function* () {
            try {
              const r = Object.assign(Object.assign(Object.assign({}, _n), e), {
                prefix: n || "",
              });
              return {
                data: yield Cn(
      ...
      class jn extends class {
        constructor(n, e = {}, t) {
          (this.url = n),
            (this.headers = Object.assign(Object.assign({}, fn), e)),
            (this.fetch = yn(t));
        }
        listBuckets() {
          return xn(this, void 0, void 0, function* () {
            try {
              return {
                data: yield Bn(this.fetch, `${this.url}/bucket`, {
                  headers: this.headers,
                }),
                error: null,
              };
        ...
        getBucket(n) {
          return xn(this, void 0, void 0, function* () {
            try {
              return {
                data: yield Bn(this.fetch, `${this.url}/bucket/${n}`, {
                  headers: this.headers,
                }),
                error: null,
              };
          ...
          return xn(this, void 0, void 0, function* () {
            try {
              const t = yield (function (n, e, t, r, o) {
                return bn(this, void 0, void 0, function* () {
                  return En(n, "PUT", e, r, undefined, t);
                });
              })(
                this.fetch,
                `${this.url}/bucket/${n}`,
        ...
        from(n) {
          return new Tn(this.url, this.headers, n, this.fetch);
        }
      }
      class On {
      ...
      class Dn {
        constructor(n, e, t) {
          ...
          const r = n.replace(/\/$/, ""),
            o = Object.assign(Object.assign({}, In), t);
          if (
        ...
        get functions() {
          return new On(this.functionsUrl, {
            headers: this._getAuthHeaders(),
            customFetch: this.fetch,
          });
        }
        get storage() {
          return new jn(this.storageUrl, this._getAuthHeaders(), this.fetch);
        }
        from(n) {
      ...
      var Rn;
      if (Pn.auth.user()) {
        for (var zn in (console.log(Pn.auth.user().email),
        console.log(
      ...
      if (Rn) {
        async function Un() {
          const { data: n, error: e } = await Pn.from("Forms").select();
          for (var t = n, r = 0; r <= t.length - 1; r++)
            document
              .getElementById("formlist")
              .insertAdjacentHTML(
                "beforeend",
                `<a href="viewform.html?id=${t[r].id}&table=${t[r].Table}" class="px-6 py-2   w-full rounded-t-lg font-inter text-sm md:text-md flex flex-row content-center items-center "><span class="iconify mr-2 inline-flex my-auto items-center content-center" data-icon="ep:document"></span><span class="my-auto items-center content-center inline-flex">${t[r].title}</span><span class="iconify ml-auto  inline-flex my-auto items-center content-center lg:hidden" data-icon="ep:arrow-right"></span></a>`
              );
        }
        Un();
      }
      (window.openNav = function () {
        ...
        (window.logout = async function () {
          await Pn.auth.signOut(), window.location.replace("index.html");
        });
    })();
})();
