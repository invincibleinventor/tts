(() => {
      ...
      497: (n, e) => {
        ...
        var t = (function () {
          ...
          return (
            ...
            (n.DEFAULT_DECIMAL_SEPARATOR = "."),
            (n.DEFAULT_QUOTE = '"'),
            (n.DEFAULT_SHOW_TITLE = !1),
            (n.DEFAULT_TITLE = "My Generated Report"),
            (n.DEFAULT_FILENAME = "generated"),
            (n.DEFAULT_SHOW_LABELS = !1),
            (n.DEFAULT_USE_TEXT_FILE = !1),
            (n.DEFAULT_USE_BOM = !0),
            (n.DEFAULT_HEADER = []),
            (n.DEFAULT_KEYS_AS_HEADERS = !1),
            n
          );
        })();
        (e.CsvConfigConsts = t),
          (e.ConfigDefaults = {
            ...
            fieldSeparator: t.DEFAULT_FIELD_SEPARATOR,
            quoteStrings: t.DEFAULT_QUOTE,
            decimalSeparator: t.DEFAULT_DECIMAL_SEPARATOR,
            showLabels: t.DEFAULT_SHOW_LABELS,
            showTitle: t.DEFAULT_SHOW_TITLE,
            title: t.DEFAULT_TITLE,
            useTextFile: t.DEFAULT_USE_TEXT_FILE,
            useBom: t.DEFAULT_USE_BOM,
            headers: t.DEFAULT_HEADER,
            useKeysAsHeaders: t.DEFAULT_KEYS_AS_HEADERS,
          });
        var r = (function () {
          function n(n) {
            this._csv = "";
            var t = n || {};
            (this._options = a({}, e.ConfigDefaults, t)),
          ...
          return (
            Object.defineProperty(n.prototype, "options", {
              ...
              set: function (n) {
                this._options = a({}, e.ConfigDefaults, n);
              },
              enumerable: !0,
              configurable: !0,
            }),
            (n.prototype.generateCsv = function (n, e) {
              if (
                (void 0 === e && (e = !1),
                (this._csv = ""),
                this._parseData(n),
                this._options.useBom && (this._csv += t.BOM),
                this._options.showTitle &&
                  (this._csv += this._options.title + "\r\n\n"),
                this._getHeaders(),
                this._getBody(),
                "" != this._csv)
              ) {
                if (e) return this._csv;
                var r = this._options.useTextFile ? "plain" : "csv",
                  o = this._options.useTextFile ? ".txt" : ".csv",
                  i = new Blob([this._csv], {
                    type: "text/" + r + ";charset=utf8;",
                  });
                if (navigator.msSaveBlob) {
                  var s = this._options.filename.replace(/ /g, "_") + o;
                  navigator.msSaveBlob(i, s);
                } else {
                  this._options.useTextFile, encodeURI(this._csv);
                  var a = document.createElement("a");
                  (a.href = URL.createObjectURL(i)),
                    a.setAttribute("visibility", "hidden"),
                    (a.download =
                      this._options.filename.replace(/ /g, "_") + o),
            ...
            (n.prototype._getHeaders = function () {
              if (this._options.showLabels || this._options.useKeysAsHeaders) {
                var n = this._options.useKeysAsHeaders
                  ? Object.keys(this._data[0])
                  : this._options.headers;
                if (n.length > 0) {
                  for (var e = "", r = 0; r < n.length; r++)
                    e += n[r] + this._options.fieldSeparator;
                  (e = e.slice(0, -1)), (this._csv += e + t.EOL);
                }
              }
            }),
            (n.prototype._getBody = function () {
              for (
                var n = Object.keys(this._data[0]), e = 0;
                e < this._data.length;
                e++
              ) {
                for (var r = "", o = 0; o < n.length; o++) {
                  var i = n[o];
                  r +=
                    this._formatData(this._data[e][i]) +
                    this._options.fieldSeparator;
                }
                (r = r.slice(0, -1)), (this._csv += r + t.EOL);
              }
            }),
            (n.prototype._formatData = function (n) {
              return "locale" === this._options.decimalSeparator &&
                this._isFloat(n)
                ? n.toLocaleString()
                : "." !== this._options.decimalSeparator && this._isFloat(n)
                ? n.toString().replace(".", this._options.decimalSeparator)
                : "string" == typeof n
                ? ((n = n.replace(/"/g, '""')),
            ...
            (n.prototype._isFloat = function (n) {
              return +n === n && (!isFinite(n) || Boolean(n % 1));
            }),
            (n.prototype._parseData = function (n) {
              return (
                (this._data = "object" != typeof n ? JSON.parse(n) : n),
                this._data
              );
            }),
            n
        ...
        function a(n) {
          for (var e, t = [], r = 1; r < arguments.length; r++)
            t[r - 1] = arguments[r];
          for (var a, A = s(n), c = 1; c < arguments.length; c++) {
            for (var l in (e = Object(arguments[c])))
              o.call(e, l) && (A[l] = e[l]);
            if (Object.getOwnPropertySymbols) {
              a = Object.getOwnPropertySymbols(e);
              for (var d = 0; d < a.length; d++)
                i.call(e, a[d]) && (A[a[d]] = e[a[d]]);
            }
          }
          return A;
        }
  ...
  (s.m = o),
    ...
    (() => {
      ...
      var g = s(818);
      const m = { "X-Client-Info": "supabase-js/1.35.6" },
        f = "Request Failed",
        ...
        return w(this, void 0, void 0, function* () {
          return new Promise((i, s) => {
            n(
              ...
              .then((n) => {
                if (!n.ok) throw n;
                return (null == r ? void 0 : r.noResolveJson) ? i : n.json();
              })
              .then((n) => i(n))
              .catch((n) =>
                ((n, e) =>
      ...
      function y(n, e, t, r) {
        return w(this, void 0, void 0, function* () {
          return C(n, "POST", e, r, t);
        });
      }
      function x(n, e, t, r) {
        return w(this, void 0, void 0, function* () {
          return C(n, "PUT", e, r, t);
        });
      }
      function k(n, e, t) {
        const r = t.map((e) => {
      ...
      function _(n, e, t) {
        e.setHeader("Set-Cookie", k(n, e, t));
      }
      ...
      const j = () => "undefined" != typeof window;
      function O(n, e) {
        var t;
        e ||
          (e =
      ...
      class $ {
        constructor({
          ...
          (this.url = n),
            (this.headers = e),
            (this.cookieOptions = Object.assign(Object.assign({}, E), t)),
            (this.fetch = D(r));
        }
          ...
          return I(this, void 0, void 0, function* () {
            try {
              ...
              const i = yield y(
                ...
                s = Object.assign({}, i);
              return (
                s.expires_in && (s.expires_at = T(i.expires_in)),
                { data: s, error: null }
              );
            } catch (n) {
          ...
          return I(this, void 0, void 0, function* () {
            try {
              const r = Object.assign({}, this.headers),
                ...
                i = Object.assign({}, o);
              return (
                i.expires_in && (i.expires_at = T(o.expires_in)),
                { data: i, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
          ...
          return I(this, void 0, void 0, function* () {
            try {
              const i = Object.assign({}, this.headers),
                ...
                A = Object.assign({}, a);
              return (
                A.expires_in && (A.expires_at = T(a.expires_in)),
                { data: A, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
          ...
          return I(this, void 0, void 0, function* () {
            try {
              const i = Object.assign({}, this.headers),
                ...
                a = Object.assign({}, s);
              return (
                a.expires_in && (a.expires_at = T(s.expires_in)),
                { data: a, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
          ...
          return I(this, void 0, void 0, function* () {
            try {
              const e = yield y(
                ...
                t = Object.assign({}, e);
              return (
                t.expires_in && (t.expires_at = T(e.expires_in)),
                { data: t, error: null }
              );
            } catch (n) {
              return { data: null, error: n };
        ...
        createUser(n) {
          return I(this, void 0, void 0, function* () {
            try {
              const e = yield y(this.fetch, `${this.url}/admin/users`, n, {
                headers: this.headers,
              });
        ...
        listUsers() {
          return I(this, void 0, void 0, function* () {
            try {
              return {
                data: (yield v(this.fetch, `${this.url}/admin/users`, {
                  headers: this.headers,
                })).users,
                error: null,
              };
        ...
        getUserById(n) {
          return I(this, void 0, void 0, function* () {
            try {
              return {
                data: yield v(this.fetch, `${this.url}/admin/users/${n}`, {
                  headers: this.headers,
                }),
                error: null,
              };
        ...
        updateUserById(n, e) {
          return I(this, void 0, void 0, function* () {
            try {
              const t = yield x(this.fetch, `${this.url}/admin/users/${n}`, e, {
                headers: this.headers,
              });
        ...
        getUser(n) {
          return I(this, void 0, void 0, function* () {
            try {
              const e = yield v(this.fetch, `${this.url}/user`, {
        ...
        updateUser(n, e) {
          return I(this, void 0, void 0, function* () {
            try {
              const t = yield x(this.fetch, `${this.url}/user`, e, {
                headers: this._createRequestHeaders(n),
              });
              return { user: t, data: t, error: null };
            } catch (n) {
      ...
      class P extends class {
        constructor(n) {
          ...
          const e = Object.assign(Object.assign({}, U), n);
        ...
        getSessionFromUrl(n) {
          return R(this, void 0, void 0, function* () {
            try {
              if (!j()) throw new Error("No browser detected.");
              const e = O("error_description");
              if (e) throw new Error(e);
              const t = O("provider_token"),
                r = O("access_token");
              if (!r) throw new Error("No access_token detected.");
              const o = O("expires_in");
              if (!o) throw new Error("No expires_in detected.");
              const i = O("refresh_token");
              if (!i) throw new Error("No refresh_token detected.");
              const s = O("token_type");
        ...
        _recoverSession() {
          try {
            const n = ((n, e) => {
              const t =
                j() && (null == n ? void 0 : n.getItem("supabase.auth.token"));
        ...
        _recoverAndRefresh() {
          return R(this, void 0, void 0, function* () {
            try {
              const e = yield ((n = this.localStorage),
              b,
              S(void 0, void 0, void 0, function* () {
                const e =
                  j() &&
                ...
                if (this.autoRefreshToken && t.refresh_token) {
                  ...
                  if (n) {
                    if (
                      ...
                      n.message === f && this.networkRetries < 10)
                    )
                      return (
      ...
      const G = { "X-Client-Info": "postgrest-js/0.37.4" };
      class H {
        constructor(
          n,
          ...
          (this.url = n),
            (this.headers = Object.assign(Object.assign({}, G), e)),
            (this.schema = t),
            (this.fetch = r),
      ...
      const K = (n, e, t = {}) => {
        ...
        W = (n, e, t, r) => {
          const o = e.find((e) => e.name === n),
            ...
            s = t[n];
          return i && !r.includes(i) ? Y(i, s) : Z(s);
        },
        Y = (n, e) => {
          if ("_" === n.charAt(0)) {
        ...
        nn = (n, e) => {
          ...
          if ("{" === n[0] && "}" === r) {
            ...
            return r.map((n) => Y(e, n));
          }
          return n;
        },
        en = (n) => ("string" == typeof n ? n.replace(" ", "T") : n);
      var tn = s(840);
      const rn = { "X-Client-Info": "realtime-js/1.7.4" };
      var on, sn, an, An, cn;
      !(function (n) {
      ...
      class un {
        constructor(n, e = {}, t) {
          (this.topic = n),
            ...
            (this.socket = t),
            (this.bindings = []),
            (this.state = sn.closed),
            (this.joinedOnce = !1),
            (this.pushBuffer = []),
            (this.timeout = this.socket.timeout),
            (this.joinPush = new hn(this, an.join, this.params, this.timeout)),
            (this.rejoinTimer = new ln(
              () => this.rejoinUntilConnected(),
              this.socket.reconnectAfterMs
            )),
            this.joinPush.receive("ok", () => {
              (this.state = sn.joined),
        ...
        unsubscribe(n = this.timeout) {
          this.state = sn.leaving;
          let e = () => {
            this.socket.log("channel", `leave ${this.topic}`),
              this.trigger(an.close, "leave", this.joinRef());
          };
          this.joinPush.destroy();
          let t = new hn(this, an.leave, {}, n);
          return (
        ...
        rejoin(n = this.timeout) {
          this.isLeaving() ||
            ...
            (this.state = sn.joining),
            this.joinPush.resend(n));
        }
        trigger(n, e, t) {
          let { close: r, error: o, leave: i, join: s } = an;
        ...
        isClosed() {
          return this.state === sn.closed;
        }
        isErrored() {
          return this.state === sn.errored;
        }
        isJoined() {
          return this.state === sn.joined;
        }
        isJoining() {
          return this.state === sn.joining;
        }
        isLeaving() {
          return this.state === sn.leaving;
        }
      }
      const pn = () => {};
      class gn {
        constructor(n, e) {
          (this.accessToken = null),
            ...
            (this.params = {}),
            (this.timeout = 1e4),
            (this.transport = tn.w3cwebsocket),
        ...
        isConnected() {
          return this.connectionState() === cn.Open;
        }
        remove(n) {
          ...
          (this.accessToken = n),
            this.channels.forEach((e) => {
              n && e.updateJoinPayload({ user_token: n }),
                e.joinedOnce &&
                  e.isJoined() &&
                  e.push(an.access_token, { access_token: n });
            });
        }
        leaveOpenTopic(n) {
        ...
        _triggerChanError() {
          this.channels.forEach((n) => n.trigger(an.error));
        }
        _appendParams(n, e) {
        ...
        getPayloadRecords(n) {
          ...
          return (
            ("INSERT" !== n.type && "UPDATE" !== n.type) ||
              (e.new = K(n.columns, n.record)),
            ("UPDATE" !== n.type && "DELETE" !== n.type) ||
              (e.old = K(n.columns, n.old_record)),
            e
          );
        }
        on(n, e) {
      ...
      const bn = { "X-Client-Info": "storage-js/1.7.3" };
      ...
      function Cn(n, e, t, r) {
        return En(this, void 0, void 0, function* () {
          return Bn(n, "GET", e, t, r);
        });
      }
      function vn(n, e, t, r, o) {
        return En(this, void 0, void 0, function* () {
          return Bn(n, "POST", e, r, o, t);
        });
      }
      function yn(n, e, t, r, o) {
        return En(this, void 0, void 0, function* () {
          return Bn(n, "DELETE", e, r, o, t);
        });
      }
      const xn = (n) => {
        let e;
      ...
      class jn {
        ...
        uploadOrUpdate(n, e, t, r) {
          return _n(this, void 0, void 0, function* () {
            try {
              let o;
              const i = Object.assign(Object.assign({}, Tn), r),
                s = Object.assign(
                  Object.assign({}, this.headers),
          ...
          return _n(this, void 0, void 0, function* () {
            try {
              const e = this._getFinalPath(n),
                t = yield Cn(this.fetch, `${this.url}/object/${e}`, {
                  headers: this.headers,
                  noResolveJson: !0,
                });
        ...
        list(n, e, t) {
          return _n(this, void 0, void 0, function* () {
            try {
              const r = Object.assign(Object.assign(Object.assign({}, Sn), e), {
                prefix: n || "",
              });
              return {
                data: yield vn(
      ...
      class On extends class {
        constructor(n, e = {}, t) {
          (this.url = n),
            (this.headers = Object.assign(Object.assign({}, bn), e)),
            (this.fetch = xn(t));
        }
        listBuckets() {
        ...
        getBucket(n) {
          return kn(this, void 0, void 0, function* () {
            try {
              return {
                data: yield Cn(this.fetch, `${this.url}/bucket/${n}`, {
                  headers: this.headers,
                }),
                error: null,
              };
          ...
          return kn(this, void 0, void 0, function* () {
            try {
              const t = yield (function (n, e, t, r, o) {
                return En(this, void 0, void 0, function* () {
                  return Bn(n, "PUT", e, r, undefined, t);
                });
              })(
                this.fetch,
                `${this.url}/bucket/${n}`,
        ...
        from(n) {
          return new jn(this.url, this.headers, n, this.fetch);
        }
      }
      class Dn {
      ...
      class Rn {
        constructor(n, e, t) {
          if (((this.supabaseUrl = n), (this.supabaseKey = e), !n))
        ...
        get storage() {
          return new On(this.storageUrl, this._getAuthHeaders(), this.fetch);
        }
        from(n) {
      ...
      var Pn,
        zn = decodeURIComponent(window.location.search),
        Mn = (zn = zn.substring(1)).split("&"),
        Nn = Mn[0].slice(Mn[0].indexOf("=") + 1),
        Ln = Mn[1].slice(Mn[1].indexOf("=") + 1);
      if (Un.auth.user()) {
        for (var Fn in (console.log(Un.auth.user().email),
        console.log(
      ...
      if (Pn) {
        async function qn() {
          const { data: n, error: e } = await Un.from("Forms").select();
          var t = n;
          document.getElementById("htitle").innerHTML = t[Nn - 1].title;
        }
        async function Gn() {
          const { data: n, error: e } = await Un.from(Ln).select();
          var t = n;
          console.log(t), Hn(t);
        }
        function Hn(n) {
          for (var e = [], t = 0; t < n.length; t++)
            for (var r in n[t]) -1 === e.indexOf(r) && e.push(r);
          var o = document.createElement("table"),
            i = document.createElement("thead");
          o.appendChild(i),
            o.classList.add("table"),
            o.classList.add("table-striped"),
            o.classList.add("table-bordered"),
            o.classList.add("table-hover");
          var s = document.createElement("tr");
          for (t = 0; t < e.length; t++) {
            var a = document.createElement("th");
            (a.innerHTML = e[t]), s.appendChild(a);
          }
          i.appendChild(s);
          ...
          for (t = 0; t < n.length; t++) {
            ...
            for (var l = 0; l < e.length; l++)
              c.insertCell(-1).innerHTML = n[t][e[l]];
          }
          A.appendChild(c), o.appendChild(A);
          var d = document.getElementById("employeedivcontainer");
          (d.innerHTML = ""), d.appendChild(o);
        }
        qn(), Gn();
      }
      (window.openNav = function () {
        ...
        (window.logout = async function () {
          await Un.auth.signOut(), window.location.replace("index.html");
        }),
        (window.downloaddata = async function () {
          ...
          new g.ExportToCsv(t).generateCsv(n);
        });
    })();
})();
