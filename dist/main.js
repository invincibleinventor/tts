...
/* harmony import */ var js_alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! js-alert */ "./node_modules/js-alert/lib/index.js");
/* harmony import */ var js_alert__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(js_alert__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var crypto_js_aes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! crypto-js/aes */ "./node_modules/crypto-js/aes.js");
/* harmony import */ var crypto_js_aes__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(crypto_js_aes__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var js_loading_overlay__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! js-loading-overlay */ "./node_modules/js-loading-overlay/dist/js-loading-overlay.min.js");
/* harmony import */ var js_loading_overlay__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(js_loading_overlay__WEBPACK_IMPORTED_MODULE_5__);
...
const supabase = (0,_supabase_supabase_js__WEBPACK_IMPORTED_MODULE_4__.createClient)("https://rsfcqodmucagrxohmkgx.supabase.co", crypto_js_aes__WEBPACK_IMPORTED_MODULE_2___default().decrypt("", `nUkRD8q(u<[YO7'W{*=_sPeca1G_wmfb*U#nof>QL4H$:@a(cqx"yijy#>I)_9e`).toString((crypto_js_enc_utf8__WEBPACK_IMPORTED_MODULE_3___default())));
...
if (supabase.auth.user()) {
  for (var ex in "admin@thetvs.com,vplvl1@thetvs.com,vplvl2@thetvs.com,vplvl3@thetvs.com".split(",")) {
    if (supabase.auth.user().email == "admin@thetvs.com,vplvl1@thetvs.com,vplvl2@thetvs.com,vplvl3@thetvs.com".split(",")[ex]) {
...
function accessAdmin() {
  if (document.getElementById("admin").classList.contains("hidden")) {
    js_alert__WEBPACK_IMPORTED_MODULE_1___default().alert(
      "You have not been granted admin access",
      null,
      (js_alert__WEBPACK_IMPORTED_MODULE_1___default().Icons.Failed)
    );
  } else {
